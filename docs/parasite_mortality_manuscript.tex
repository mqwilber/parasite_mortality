...
\textbf{2.1 A novel, likelihood-based method for estimating PIHM}
...
\textbf{2.2 Evaluating the Adjei and Likelihood Methods}
...
\textbf{2.3 Application to real data}
...
\textbf{3.1 Question 1: Detecting presence of PIHM}
...
\textbf{3.2 Question 2: Estimating the $LD_{50}$ and survival function}
...
\textbf{3.3 Application to real data}
