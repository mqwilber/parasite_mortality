...
\begin{itemize}
    ...
    \item  All current methods for detecting parasite-induced host mortality have fundamental and untestable assumptions that limit their applicability in the real world.
\end{itemize}
