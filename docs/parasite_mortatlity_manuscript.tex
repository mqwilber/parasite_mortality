...
% Change statistical alpha to something else so I don't confuse it with pathogenecity alpha.

% Set sample size to be small. (50 or 100) and then vary k and mu, Make some sort of heat map to show this?

% What figures do we want to show?  Represent figures in a single frame? Pick one that shows the general pattern? Maybe drop the a figure to the Supplement?

% Crop Figure 2 and merge Fig 3-4 to have 4 panels.

% Fiddle with Figure 1 to make it a plate in The new figure 2? Inset it in some way.

% Figure 3: Just focus on small (100) size and vary mu and k and see what happens. (Chose steep survival function for LD50)
